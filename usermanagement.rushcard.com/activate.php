...
<!-- Mirrored from usermanagement.rushcard.com/activate by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 May 2021 18:52:40 GMT -->
...
<form action="activate.php" id="ActivateSecurityCredentialsForm" method="post" role="form"><input name="__RequestVerificationToken" type="hidden" value="tmFLSinLE7XI9c1GCEKJSR0iZ0D3gXGCNgcVtlyW79YmEWJxQEqqAcJjUkU_C9z39IgDuhJKtWC07tBWODzyoySwiP81" />
...
<div class="button-group">
    <button id="btnCardLookupSubmit" type="submit" name="submit"  class="btn btn-primary" >Next</button><a alt="Back to Login" class="cancel" href="login.php" tabindex="8">Cancel</a>
</div>
